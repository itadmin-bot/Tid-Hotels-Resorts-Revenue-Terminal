    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/95 overflow-y-auto no-print">
      <div className="flex flex-col h-full w-full max-w-4xl p-4">
        ...
        <div className="flex-1 bg-gray-300 p-2 md:p-8 rounded-xl shadow-inner mx-auto overflow-y-auto w-full flex justify-center">
          <div className="bg-white p-0 print:shadow-none print-active h-fit">
            {isPos ? (
              <div className="docket-container text-black bg-white p-0 font-mono text-[11px] leading-tight border-none shadow-none">
                ...
                <div className="text-center mb-1">
                  ...
                  <p className="text-[8px] font-bold opacity-80 uppercase leading-none mt-0.5">{settings.hotelAddress}</p>
                </div>

                {/* Metadata Row */}
                <div className="grid grid-cols-2 gap-x-2 uppercase text-[9px] border-b border-dashed border-black/30 pb-0.5 mb-1">
                ...
                {/* Items Section */}
                <div className="mb-1">
                  <div className="font-black flex justify-between border-b border-black/30 pb-0.5 mb-0.5 text-[9px]">
                    <span>ITEM/QTY</span>
                    <span>TOTAL</span>
                  </div>
                    ...
                    return (
                      <div key={idx} className="mb-0.5 pb-0.5 border-b border-dotted border-black/10 last:border-0">
                        <div className="flex justify-between items-start">
                          <span className="font-bold uppercase text-[10px] flex-1 leading-none">
                ...
                {/* Financial Summary */}
                <div className="space-y-0.5 text-[10px] mb-1 font-bold border-t border-dashed border-black/30 pt-0.5">
                ...
                {/* Grand Total */}
                <div className="flex justify-between items-center mb-1 border-t border-black pt-0.5">
                ...
                <div className="space-y-0.5 mb-1 uppercase text-[9px]">
                  ...
                  <div className="flex justify-between font-black text-[11px] border-t border-dotted border-black/30 pt-0.5 mt-0.5">
                    <span>BALANCE:</span>
                ...
                {transaction.balance > 0 && (
                  <div className="mb-1 border border-dotted border-black/50 p-0.5">
                    <p className="font-black text-[8px] uppercase opacity-70">Payment Portal:</p>
                    {currentBanks.map((bank, i) => (
                      <p key={i} className="text-[9px] font-bold leading-none">{bank.bank}: {bank.accountNumber}</p>
                    ))}
                  </div>
                )}

                {/* Footer */}
                <div className="text-center italic text-[8px] font-black border-t border-black/30 pt-0.5 mt-0.5">
                  VERIFIED REVENUE DOCUMENT • TIDÈ
                </div>
              </div>
            ) : (
              <div className="invoice-container text-black bg-white p-[10mm] md:p-[20mm] font-sans text-sm shadow-none">
