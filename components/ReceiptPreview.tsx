  ...
  const handlePrint = () => {
    ...
    const style = isPos ? `
      ...
      * { box-sizing: border-box !important; }
      ...
      .item-row { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 1.5mm; font-size: 10px; }
    ...
    <>
            ...
            {isPos ? (
              ...
              <div className="bg-white p-8 shadow-2xl h-fit w-[80mm] text-black font-mono">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between text-[10px] font-black border-b border-black pb-1 mb-1 uppercase">
                    ...
                    {transaction.items.map((item, idx) => {
                      ...
                      return (
                        <div key={idx}>
                          <div className="flex justify-between text-[11px] font-bold uppercase">
                            <span className="w-[40%] text-left truncate pr-1">{name}</span>
              ...
              <div className="bg-white p-[15mm] shadow-2xl h-fit w-[210mm] max-w-full text-black font-inter min-h-[297mm] box-border">
                  ...
                  <table className="w-full mb-10">
                    <thead>
                      <tr className="bg-gray-50">
                        ...
                        <th className="text-right py-4 px-4 text-[10px] font-black uppercase tracking-widest text-gray-500">Unit Price (₦)</th>
                  ...
                  <div className="mt-auto pt-10 text-center text-[9px] font-bold text-gray-400 uppercase tracking-[0.5em]">
                    This is an official revenue record generated by {settings.hotelName}.
                  </div>
              </div>
            )}
          </div>
      ...
      <div className="absolute -left-[9999px] top-0 pointer-events-none" aria-hidden="true" style={{ visibility: 'hidden' }}>
        ...
        <div id="thermal-pos-docket" style={{ visibility: 'visible', width: '80mm', background: 'white', padding: '6mm 4mm' }}>
          ...
          <div className="divider"></div>
          <div className="item-row bold uppercase" style={{fontSize: '10px', borderBottom: '1px solid #000', paddingBottom: '1mm', marginBottom: '1mm'}}>
            ...
            return (
              <div key={idx} style={{marginBottom: '2mm'}}>
                <div className="item-row">
                  <span className="col-item uppercase bold">{name}</span>
                  <span className="col-qty bold">{item.quantity}</span>
                  <span className="col-unit">₦{item.price.toLocaleString()}</span>
                  <span className="col-total">₦{item.total.toLocaleString()}</span>
                </div>
