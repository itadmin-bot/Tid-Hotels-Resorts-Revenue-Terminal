    ...
    <>
        ...
        <div className="flex flex-col h-full w-full max-w-5xl p-4">
          <div className="flex justify-between items-center mb-6">
            <div className="flex items-center gap-3">
              ...
              <h3 className="text-white font-bold tracking-widest uppercase text-sm">Official Receipt Dispatch</h3>
            </div>
          ...
          <div className="flex-1 bg-[#0B1C2D] p-4 md:p-8 rounded-2xl shadow-inner mx-auto overflow-auto w-full flex justify-center border border-white/5">
            {isPos ? (
              ...
              <div className="bg-white p-8 shadow-2xl h-fit w-[80mm] text-black font-mono">
                  ...
                  <div className="text-center italic text-[9px] font-black border-t border-black pt-4 uppercase">Verified Record</div>
              </div>
            ) : (
              /* A4 Preview (Large) */
              <div className="bg-white p-[15mm] shadow-2xl h-fit w-[210mm] max-w-full text-black font-inter min-h-[297mm] box-border">
                  ...
                  <div className="mt-auto pt-10 text-center text-[9px] font-bold text-gray-400 uppercase tracking-[0.5em]">
                    This is an official record generated by {settings.hotelName} Management System.
                  </div>
              </div>
            )}
          </div>
      ...
      <div className="absolute -left-[9999px] top-0 pointer-events-none" aria-hidden="true" style={{ visibility: 'hidden' }}>
        ...
        <div id="thermal-pos-docket" style={{ visibility: 'visible', width: '80mm', background: 'white', padding: '6mm 4mm' }}>
          ...
          <div className="center bold uppercase" style={{fontSize: '9px'}}>Official Record</div>
        </div>
          ...
          <div className="footer">
            <div className="bank-list">
              ...
              <div style={{marginTop: '10mm', fontSize: '9px', color: '#999', textTransform: 'uppercase'}} className="bold italic">
                Verified Corporate Folio Dispatch. Generated by {settings.hotelName} Management System.
              </div>
            </div>
